 ...
 */
class BubbleOptionHintPopup private constructor(val context: Context, val hintStr: String) :
    ...
    companion object {
        ...
        fun create(
            context: Context,
            hintStr: String?
        ): BubbleOptionHintPopup {
            return BubbleOptionHintPopup(context, hintStr ?: "")
        }
    }
    ...
    private var mCallback: BubbleOptionHintPopupCallback? = null

    /**
     * 初始化调用时候有效果
     */
    fun setAnimationStyleRes(@StyleRes animationStyle: Int): BubbleOptionHintPopup {
        mAnimationStyle = animationStyle
        return this
    }

    fun setItemClick(
        callback: BubbleOptionHintPopupCallback
    ): BubbleOptionHintPopup {
        mCallback = callback
        return this
    }
    ...
    init {
        ...
        mView = LayoutInflater.from(this.context).inflate(R.layout.midm_bubble_option_hint, null)
        contentView = mView
        ...
        mView.findViewById<TextView>(R.id.content_tv).text = hintStr
